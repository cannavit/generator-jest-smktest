let arg,inquirer,createProject,runMultiTasks,figlet,generateCasesSwagger,cliKubernetes,promptDocker;_b2c‍.x([["cli",()=>cli]]);_b2c‍.w("arg",[["default",["arg"],function(v){arg=v}]]);_b2c‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);_b2c‍.w("./main",[["createProject",["createProject"],function(v){createProject=v}],["runMultiTasks",["runMultiTasks"],function(v){runMultiTasks=v}]]);_b2c‍.w("figlet",[["default",["figlet"],function(v){figlet=v}]]);_b2c‍.w("./services/smktestSwagger",[["generateCasesSwagger",["generateCasesSwagger"],function(v){generateCasesSwagger=v}]]);_b2c‍.w("./services/kubernetesApi/cli.js",[["cliKubernetes",["cliKubernetes"],function(v){cliKubernetes=v}]]);_b2c‍.w("./services/dockerService",[["default",["promptDocker"],function(v){promptDocker=v}]]);
...
// create-smktest --context=kubernetes --projectName=edutelling-test
