let arg,inquirer,createProject,runMultiTasks,figlet,generateCasesSwagger;_e3b‍.x([["cli",()=>cli]]);_e3b‍.w("arg",[["default",["arg"],function(v){arg=v}]]);_e3b‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);_e3b‍.w("./main",[["createProject",["createProject"],function(v){createProject=v}],["runMultiTasks",["runMultiTasks"],function(v){runMultiTasks=v}]]);_e3b‍.w("figlet",[["default",["figlet"],function(v){figlet=v}]]);_e3b‍.w("./services/smktestSwagger",[["generateCasesSwagger",["generateCasesSwagger"],function(v){generateCasesSwagger=v}]]);
