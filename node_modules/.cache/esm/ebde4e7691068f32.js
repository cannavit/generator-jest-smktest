let inquirer,createTable,axios,response,curlSmkTest;_910‍.x([["default",()=>promptDocker]]);_910‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);_910‍.w("./smktestSwagger",[["createTable",["createTable"],function(v){createTable=v}]]);_910‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_910‍.w("express",[["response",["response"],function(v){response=v}]]);_910‍.w("./smktestCurl",[["curlSmkTest",["curlSmkTest"],function(v){curlSmkTest=v}]]);const shell = require('shelljs');
...
async function dockerOptions(options) {
  ...
  console.log('>>>>>-1184611897>>>>>');
  _910‍.g.console.log(responseData);
  _910‍.g.console.log(options.docker.urlResponse);
  console.log('<<<<<<<<<<<<<<<<<<<');
